...
public class CreateFakeReadsParams {
    ...
    public CreateFakeReadsParams withWsId(Long wsId) {
        this.wsId = wsId;
        return this;
    }
    ...
    public CreateFakeReadsParams withWsName(java.lang.String wsName) {
        this.wsName = wsName;
        return this;
    }
    ...
    public CreateFakeReadsParams withObjNames(List<String> objNames) {
        this.objNames = objNames;
        return this;
    }
    ...
    public CreateFakeReadsParams withMetadata(Map<String, String> metadata) {
        this.metadata = metadata;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((("CreateFakeReadsParams"+" [wsId=")+ wsId)+", wsName=")+ wsName)+", objNames=")+ objNames)+", metadata=")+ metadata)+", additionalProperties=")+ additionalProperties)+"]");
    }
