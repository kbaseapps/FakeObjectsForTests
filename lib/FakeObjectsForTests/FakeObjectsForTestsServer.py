...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'FakeObjectsForTests'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from FakeObjectsForTests.FakeObjectsForTestsImpl import FakeObjectsForTests  # noqa @IgnorePep8
impl_FakeObjectsForTests = FakeObjectsForTests(config)
